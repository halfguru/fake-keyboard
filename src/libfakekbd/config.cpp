...
auto config_parser::from_file(std::string_view path) -> std::optional<config>
{
  try
  {
...
auto config_parser::from_json(std::string_view json_str) -> std::optional<config>
{
  try
  {
...
auto config_parser::from_json(nlohmann::json const& json) -> std::optional<config>
{
  try
  {
    config cfg;
...
auto config_parser::parse_device_config(nlohmann::json const& json) -> device_config
{
  device_config cfg;
...
auto config_parser::parse_bluetooth_config(nlohmann::json const& json) -> bluetooth_config
{
